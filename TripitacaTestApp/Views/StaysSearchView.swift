...
struct StaysSearchView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                HStack(alignment: .center, spacing: 5) {
                    ...
                    DatePicker(selection: $checkOutDate, in: Date()..., displayedComponents: [.date]) {
                        Text("Select a date")
                            .font(.footnote)
                    }
                }
        ...
        NavigationLink(isActive: $showStays) { StaysListView() } label: { }.hidden()
    }
    ...
    func search() {
        dataManager.searchOption = 0
        dataManager.searchStays(locationText: location, guests: adults)
        self.closeSearch = true
    }
}

struct StaysSearchView_Previews: PreviewProvider {
    static var previews: some View {
        StaysSearchView(closeSearch: .constant(false))
    }
}
